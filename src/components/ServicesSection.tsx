      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-dark-bg rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/80 leading-relaxed">
                Product Development, Monetization Due Diligence and Ongoing
                Strategic Support.
              </p>
            </div>
          </div>
          ...
          <div className="bg-dark-bg rounded-2xl p-8 text-white relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-dark-bg to-dark-card"></div>
            <div className="relative z-10">
              <h3 className="text-2xl font-bold mb-6">Exits</h3>
              <p className="text-white/80 leading-relaxed">
                Access our extensive network of buyers & brokers to help you
                get the right valuation if & when you want to sell!
              </p>
            </div>
          </div>
        </div>
